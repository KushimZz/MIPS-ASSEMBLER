...
public class MIPSAssembler {
    ...
    public static String instruction(String instruction, Map<String, Integer> labels, int currentAddress) {
        ...
        String first = parts[0]; // The first part is instructions
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<String, Integer> labels = labelSeparation(lines); // separate the labels and their addresses
